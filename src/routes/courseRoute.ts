...
router.get(
  "/admin",
  asyncHandler(courseController.getCoursesForAdmin.bind(courseController)),
);
router.get(
  "/:id",
...
router.get(
  ...
  asyncHandler(
    courseController.getCoursesByInstructorId.bind(courseController),
  ),
);
router.get(
  "/related/:courseId",
  asyncHandler(courseController.getRelatedCourses.bind(courseController)),
);
...
router.put(
  "/:id/image",
  upload.single("image"),
  asyncHandler(courseController.updateCourseImage.bind(courseController)),
);
router.delete(
  "/:id",
...
router.post(
  "/refresh-embeddings",
  authenticateToken,
  asyncHandler(courseController.refreshEmbeddings.bind(courseController)),
);
